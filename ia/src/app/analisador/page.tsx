                ...
                {isOtcAsset ? (
                    <div className="w-full h-full flex items-center justify-center bg-black/20 p-6 relative overflow-hidden">
                        ...
                        <div className="absolute inset-0 z-0 flex items-center justify-center opacity-25">
                           <CelestialOrbHero />
                           <svg className="hidden" width="400" height="400" viewBox="0 0 100 100">
                        ...
                        <div className="text-center max-w-md relative z-10 animate-in zoom-in-95 duration-700 flex flex-col items-center justify-center">
