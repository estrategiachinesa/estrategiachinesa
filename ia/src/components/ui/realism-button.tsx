  ...
  ({ text, children, className, ...props }, ref) => {
    return (
      <button
        ref={ref}
        className={cn(
          "group relative p-[2px] rounded-[16px] text-[1.1rem] border-none cursor-pointer bg-[radial-gradient(circle_80px_at_80%_-10%,_#ffffff,_#181b1b)] transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none select-none",
          className
        )}
        {...props}
      >
        ...
        {/* Inner content */}
        <div className="relative px-[25px] py-[14px] group-hover:scale-105 rounded-[14px] text-white bg-[radial-gradient(circle_80px_at_80%_-50%,_#777777,_#0f1111)] z-10 transition-all duration-300 flex items-center justify-center gap-2">
          {text || children}
